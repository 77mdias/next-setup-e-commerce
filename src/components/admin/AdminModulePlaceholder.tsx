    ...
    <section className="space-y-5">
      <div className="rounded-2xl border border-white/6 bg-[#1b1712] p-6">
        ...
        <div className="mt-4 max-w-3xl space-y-2">
          ...
          <p className="[font-family:var(--font-arimo)] text-sm leading-relaxed text-[#b8ad9f] sm:text-base">
            {description}
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
        <div className="rounded-2xl border border-white/6 bg-[#1b1712] p-6">
          ...
          <div className="mt-4 space-y-2">
            {checklist.map((item) => (
              <div
                key={item}
                className="rounded-xl border border-white/6 bg-[#17140f] px-4 py-3 [font-family:var(--font-arimo)] text-sm leading-6 text-[#f2eee8]"
              >
                {item}
              </div>
            ))}
        ...
        <div className="rounded-2xl border border-[#59627a]/20 bg-[#59627a]/5 p-6">
          <p className="[font-family:var(--font-arimo)] text-xs font-semibold tracking-[0.2em] text-[#59627a] uppercase">
            Próximo passo
          </p>
          <p className="mt-4 [font-family:var(--font-arimo)] text-sm leading-7 text-[#b8ad9f]">
          ...
          <Link
            className="mt-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-[#17140f] px-4 py-2 [font-family:var(--font-arimo)] text-sm font-semibold text-[#f2eee8] transition hover:border-[#59627a]/40 hover:text-[#59627a]"
            href={ctaHref}
          >
            {ctaLabel}
